    ...
    return (
        <>
            <section className="pt-8 md:pt-24 w-screen -ml-[calc(50vw-50%)] overflow-hidden">
                <div className="max-w-7xl mx-auto bg-green-900 text-white rounded-t-3xl px-4 py-8 md:px-20 md:py-20">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl md:text-5xl font-bold" style={{ lineHeight: "1.5" }}>
                            Cómo Avovite Transforma su Inversión en <span className="text-yellow-300">Crecimiento Sostenible</span>
                        </h2>
                    </div>
